...
df_counts <- df %>% group_by(Target, Prev_quali) %>% count()
...
plot_ly(
  ...
  layout(title="Number of Students by Previous qualification and Target value", xaxis= list(title="Previous qualification"), yaxis=list(title="Count"))
```
